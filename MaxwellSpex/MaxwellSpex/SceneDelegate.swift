...
//
//  Licencing info 
//  FileHash: 30330F02-2F45-497A-96D6-243AB723E370
...
class HostingController: UIHostingController<AnyView> {
    override var preferredStatusBarStyle: UIStatusBarStyle {
        return Look.current.scheme == .light ? .darkContent : .lightContent
    }
}

class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    var window: UIWindow?
    static var rootVC: HostingController?
    ...
    func scene(_ scene: UIScene, willConnectTo _: UISceneSession, options _: UIScene.ConnectionOptions) {
        ...
        if let windowScene = scene as? UIWindowScene {
            ...
            Self.rootVC = HostingController(rootView: contentView.lux.view)
    ...
    func scene(_: UIScene, openURLContexts URLContexts: Set<UIOpenURLContext>) {
        // TODO: ie. <UIOpenURLContext: 0x28097a540; URL: file:///private/var/mobile/Containers/Data/Application/03DACFE7-6FF3-4927-B270-EB0605E5351E/Documents/Inbox/MAXWELL_V1-2.lux; options: <UISceneOpenURLOptions: 0x280766190; sourceApp: (null); annotation: (null); openInPlace: NO>>
        for context in URLContexts {
            ...
            ImportModel.shared.checkForContinuedLocalAssetURL(context.url, suggestion: false)
    ...
    func scene(_: UIScene, continue userActivity: NSUserActivity) {
        if let url = userActivity.webpageURL {
            ImportModel.shared.checkForUniversalURL(url, suggestion: false)
        }
    }
}

extension SceneDelegate {
    func link(appModel: AppModel) {
        ATracker.appGetter = { appModel }
    }
    ...
    func config(windowScene: UIWindowScene) {
