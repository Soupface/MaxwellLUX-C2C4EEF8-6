...
//
//  Licencing info 
//  FileHash: B8CBFEFA-3BCC-4291-910D-E3AC47C56F32
...
class PhotoLibrary: NSObject, ObservableObject, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    typealias PhotoLibraryCompletion = (UIImage?) -> Void

    @Published var picker: UIImagePickerController?
    @Published var completion: PhotoLibraryCompletion?

    func importPicture(completion: PhotoLibraryCompletion?) {
        assert(self.completion == nil, "concurrent opreations not permited")
