...
//
//  Licencing info 
//  FileHash: D2DDD17A-00A8-4519-87A6-5A90BF291C4E
...
struct FontPickerController: UIViewControllerRepresentable {
...
//        configuration.filteredTraits = [.classModernSerifs]
    ...
    class Coordinator: NSObject, UIFontPickerViewControllerDelegate {
        var parent: FontPickerController
        var model: EditorModel

        init(_ picker: FontPickerController, model: EditorModel) {
            parent = picker
            self.model = model
        }
        ...
        func fontPickerViewControllerDidPickFont(_ viewController: UIFontPickerViewController) {
            ...
            model.editingFontBinding.wrappedValue = font
            model.isPickingFont = false
        }
